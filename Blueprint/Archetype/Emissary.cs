...
namespace PrestigePlus.Blueprint.Archetype
{
    internal class Emissary
    {
        ...
        public static void Configure()
        {
            ...
            .SetRemoveFeaturesEntry(1, FeatureSelectionRefs.CavalierTacticianFeatSelection.ToString(), FeatureRefs.CavalierTacticianFeature.ToString())
            ...
            .AddToAddFeatures(1, FeatureRefs.MountedCombat.ToString())
