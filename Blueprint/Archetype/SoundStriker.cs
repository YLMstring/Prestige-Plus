...
namespace PrestigePlus.Blueprint.Archetype
{
    internal class SoundStriker
    {
        ...
        public static void Configure()
        {
            ...
            .SetRemoveFeaturesEntry(7, FeatureRefs.InspireCompetenceFeature.ToString())
            .SetRemoveFeaturesEntry(11, FeatureRefs.InspireCompetenceFeature.ToString())
            .SetRemoveFeaturesEntry(15, FeatureRefs.InspireCompetenceFeature.ToString())
            .SetRemoveFeaturesEntry(19, FeatureRefs.InspireCompetenceFeature.ToString())
