    ...
    internal class GrabbingStyle
    {
        ...
        public static void DragConfigure()
        {
            ...
            FeatureConfigurator.New(DragName, DragGuid, FeatureGroup.Feat)
                    ...
                    .SetDescription(DragDescription)
                    .SetIcon(icon)
                    .AddPrerequisiteStatValue(StatType.BaseAttackBonus, 8, group: Kingmaker.Blueprints.Classes.Prerequisites.Prerequisite.GroupType.Any)
                    .AddPrerequisiteClassLevel(CharacterClassRefs.MonkClass.ToString(), 4, group: Kingmaker.Blueprints.Classes.Prerequisites.Prerequisite.GroupType.Any)
        ...
        public static void MasterConfigure()
        {
            ...
            FeatureConfigurator.New(MasterName, MasterGuid, FeatureGroup.Feat)
                    ...
                    .SetIcon(icon)
                    .AddPrerequisiteStatValue(StatType.BaseAttackBonus, 12, group: Kingmaker.Blueprints.Classes.Prerequisites.Prerequisite.GroupType.Any)
                    .AddPrerequisiteClassLevel(CharacterClassRefs.MonkClass.ToString(), 8, group: Kingmaker.Blueprints.Classes.Prerequisites.Prerequisite.GroupType.Any)
