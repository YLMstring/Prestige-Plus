       ...
       ModMenu.ModMenu.AddSettings(
                ...
                try
        {
          ...
          Initialized = true;
                    ...
                    Logger.Info("Configuring blueprints."); ReplaceAttack.DisarmConfigure(); ReplaceAttack.SunderConfigure(); ReplaceAttack.TripConfigure(); StrengthSurge.StrengthSurgeFeat();
