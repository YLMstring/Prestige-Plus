            ...
            foreach (EntityPartRef<UnitEntityData, UnitPartPet> entityPartRef in base.Owner.Pets)
            {
                ...
                if (unitPartPet != null)
                {
                    if (level >= 9)
                    {
                        ...
                        entity.Stats.AC.AddModifier(4, base.Runtime, ModifierDescriptor.NaturalArmor);
                    }
                    else if (level >= 7) 
                    {
                        ...
                        entity.Stats.AC.AddModifier(3, base.Runtime, ModifierDescriptor.NaturalArmor);
                    }
                    else if (level >= 5)
                    {
                        entity.Stats.Strength.AddModifier(6, base.Runtime, ModifierDescriptor.UntypedStackable);
                        entity.Stats.Constitution.AddModifier(4, base.Runtime, ModifierDescriptor.UntypedStackable);
                        entity.Stats.AC.AddModifier(2, base.Runtime, ModifierDescriptor.NaturalArmor);
                    }
                    else if (level >= 3)
                    {
                        ...
                        entity.Stats.AC.AddModifier(1, base.Runtime, ModifierDescriptor.NaturalArmor);
                    }
                    else
                    {
